...
def main_menu():
    ...
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("./assets/img/BACKGOUND/Play Rect.png"), pos=(WORLD_X/2, 350*u), 
                            text_input="PLAY", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        # CONTINUE_BUTTON = Button(image=pygame.image.load("./assets/img/BACKGOUND/options Rect.png"), pos=(WORLD_X/2, 500*u), 
        #                     text_input="CONTINUE", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        # QUIT_BUTTON = Button(image=pygame.image.load("./assets/img/BACKGOUND/Quit Rect.png"), pos=(WORLD_X/2, 650), 
        #                     text_input="QUIT", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("./assets/img/BACKGOUND/Quit Rect.png"), pos=(WORLD_X/2, 500*u), 
                            text_input="QUIT", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
